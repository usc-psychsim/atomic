...
from model_learning.util.io import get_file_name_without_extension, create_clear_dir, save_object, change_log_handler, \
    load_object
from atomic_domain_definitions.analyze import Replayer, default_maps
from atomic_domain_definitions.parser_no_pre import TrajectoryParser
from atomic_domain_definitions.plotting import plot, plot_trajectories, plot_agent_location_frequencies, \
    plot_agent_action_frequencies, plot_location_frequencies, plot_action_frequencies
from atomic_domain_definitions.model_learning.linear.rewards import create_reward_vector
...
class RewardModelAnalyzer(Replayer):
    ...
    def post_replay(self, parser, world, agent, observer, map_table):
        ...
        rwd_vector = create_reward_vector(agent, locations, Locations.moveActions[agent.name])
