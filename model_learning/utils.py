...
__description__ = 'utility function to associate participant data with start/stop times, stop times are important right now becasue parsing past a certain point on different files will break'
