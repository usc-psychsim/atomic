...
# read necessary portions of message bus for psychsim
...
class room(object):
    def __init__(self, name, x0, z0, x1, z1):
        ...
        self.xrange = range(x0,x1) # add 1 to range here too?? likely not cuz edge will be wall
...
#            self.add_room(alldat,msg_type)            
    ...
    def check_type(self,jtxt):
        ...
        if jtxt.find('Event:Triage') > -1:
            ...
            self.psychsim_tags += ['playername', 'open', 'door_x', 'door_y', 'door_z', 'room1', 'room2']
            msg_type = 'door'
