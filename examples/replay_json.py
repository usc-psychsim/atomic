...
reader.load_rooms('/home/mostafh/Documents/psim/new_atomic/atomic/data/ASIST_FalconMap_Rooms_v1.1_OCN.csv')
reader.load_doors('/home/mostafh/Documents/psim/new_atomic/atomic/data/ASIST_FalconMap_Portals_v1.1_OCN.csv')
...
jsonParser = ProcessParsedJson(playerName, world_map, victimsObj, logger=logging)
