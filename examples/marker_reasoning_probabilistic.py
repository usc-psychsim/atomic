...
RDDL_FILE = os.path.join(os.path.dirname(__file__), '..', 'data', 'rddl_psim', 'mark_v1_template_prob_markers.rddl')
...
print('Done printing p1 initial belief')
