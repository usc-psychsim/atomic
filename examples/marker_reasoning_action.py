...
THRESHOLD = 0
RDDL_FILE = os.path.join(os.path.dirname(__file__), '..', 'data', 'rddl_psim', 'mark_v1_template_action.rddl')
...
json_msg_action_lookup_fname = os.path.join(os.path.dirname(__file__), '..', 'data', 'rddl_psim', 'rddl2actions_fol_markers.csv')
...
all_msgs.append({'p1': {'type':'Marker Block 1', 'playername':'p1', 'sub_type':'Event:MarkerPlaced'}, 
                 'p2': {'type':'Marker Block 1', 'playername':'p2', 'sub_type':'Event:MarkerPlaced'}})
